...
const translations = {
  en: {
    ...
    contact_success_desc: "Your message has been delivered to the author's inbox. Thank you for your valuable feedback and guidance!",
  ...
  zh: {
    ...
    contact_success_desc: "您的訊息已寄送至作者的電子信箱。感謝您的寶貴指教與回饋！",
