...
const translations = {
  en: {
    ...
    db_profile_title: "About Me",
    db_profile_desc: "Backend software engineer background. After experiencing city life in Taipei (northern Taiwan), I am seeking opportunities in Central or Southern Taiwan to transition away from the 'Taipei drift' and be closer to family. Having recently completed my Master's degree in Australia, this decision to study abroad demonstrates my courage to face unknown environments and challenges, as well as how much I value continuous learning and self-improvement. In this new era of AI, I aim to focus on Data Engineering, including ETL construction, domain-specific business data analysis, Power BI dashboard development, and Python automation integration.",
    ...
    career_unisa_company: "Adelaide University",
    ...
    exp_uni_company: "Adelaide University",
    exp_uni_desc: "Business Analytics specialization at Adelaide University. Focused on large-scale database design, architectural planning, and database management.",
    ...
    // Projects
    proj_badge: "Showcase",
    proj_title: "Personal Projects & Planning",
    proj_subtitle: "Real-world work demonstrating data engineering, pipeline design, and analytical thinking.",
    proj_tab_all: "All Projects",
    proj_tab_de: "Data & Pipelines",
    proj_tab_ai: "AI & Full-Stack",
    ...
    proj_legal_title: "Public Safety & Integrity Analytics",
    proj_legal_desc: "A data pipeline and analytics dashboard comparing official crime statistics from MOI with public opinions. Implements automated crime classification, regional risk indices, and rule-based legal judgment extraction.",
    proj_legal_highlight: "Data Pipeline & In-Memory SPA",
    ...
    skills_desc: "Engineering and data skill sets built upon backend software development and analytics experience.",
    skills_cat_backend: "Backend Development",
    skills_desc_backend: "Building secure, scalable APIs and services with relational databases and containerized deployments.",
    skills_impact_backend: "Ensures reliable business logic flow and high system availability.",
    skills_cat_data: "Data Engineering, Automation & Machine Learning",
    skills_desc_data: "Designing robust ETL pipelines, scheduling automation scripts, and applying machine learning models for predictive analytics.",
    skills_impact_data: "Automates repetitive workflows and prepares structured datasets for advanced analytical models.",
    skills_cat_analytics: "Data Analysis & Visualization",
    skills_desc_analytics: "Extracting business trends, calculating key performance metrics, and building interactive Power BI dashboards.",
    skills_impact_analytics: "Translates raw numbers into intuitive reports to support operational decisions.",

    // Contact
    contact_badge: "Contact",
    contact_title: "Collaborate & Feedback",
  ...
  zh: {
    ...
    db_stat_status_val: "開放求職中",
    db_stat_status_lbl: "目前求職狀態",
    db_timeline_title: "職涯發展路徑",
    db_timeline_subtitle: "發展時間軸軌跡",
    db_profile_title: "個人簡介",
    db_profile_desc: "擁有後端軟體工程背景。經歷了多年的北漂生活後，我希望能回到中南部工作發展，擺脫高消費的生活成本並就近陪伴家人與生活。剛結束海外碩士學位的洗禮，我想出國的這個決定足以證明我面對未知環境與挑戰的勇氣以及我個人對長期成長的重視。在 AI 的新時代，我想未來專注在數據工程領域的發展，包含 ETL 資料的建置、產業領域的專業數據分析、Power BI 數據儀表板的開發與 Python 的自動化應用整合規劃。",
    db_tech_stack: "核心技術棧",
    ...
    exp_nchu_title: "中興大學 AI人工智慧與數據分析應用班",
    exp_nchu_company: "中興大學",
    exp_nchu_desc: "國立中興大學職前訓練課程，專注於人工智慧應用、資料探勘與大數據分析工作流之實踐。",

    exp_uni_title: "資訊科技碩士 (IT)",
    exp_uni_company: "阿德萊德大學",
    exp_uni_desc: "阿德萊德大學 (Adelaide University) 碩士，主修商業分析 (Business Analytics)。專注於大型數據庫系統設計、架構規劃與數據庫管理能力的培養。",
    ...
    // Projects
    proj_badge: "實作展示",
    proj_title: "個人專案實作與規劃",
    proj_subtitle: "展示數據工程、數據流水線設計及分析思維的實際案例與規劃構想。",
    proj_tab_all: "全部專案",
    proj_tab_de: "數據工程與流水線",
    proj_tab_ai: "AI與全端應用",
    ...
    proj_linebot_highlight: "LINE Bot + n8n",
    proj_legal_title: "公共安全與廉政司法數據對照平台",
    proj_legal_desc: "數據流水線與分析儀表板專案，對照內政部警政單月刑事案件與輿論聲量。整合自動案類分類、各縣市加權治安風險指標，與規則式裁判摘要篩選，並在前端以記憶體過濾實作無伺服器 Live Demo 方案。",
    proj_legal_highlight: "數據流水線與靜態 SPA 降級方案",
    ...
    skills_desc: "立足於後端軟體工程與資料分析經驗，所建構的系統開發與數據處理技能。",
    skills_cat_backend: "後端系統開發",
    skills_desc_backend: "建構穩定且安全的後端 API 與服務，並進行資料庫設計與容器化部署。",
    skills_impact_backend: "確保商業邏輯運作流暢以及系統的穩定度。",
    skills_cat_data: "數據工程、自動化與機器學習",
    skills_desc_data: "規劃與實作 ETL 數據流水線、自動化排程與清洗，並結合機器學習模型進行預測分析。",
    skills_impact_data: "減少人工重複作業，為後續數據分析與機器學習模型打下乾淨的數據基礎。",
    skills_cat_analytics: "數據分析與視覺化",
    skills_desc_analytics: "自資料庫查詢與分析業務趨勢，設計 Power BI 互動式儀表板以呈現關鍵數據指標。",
    skills_impact_analytics: "將原始數據轉換為直觀的分析報表，以輔助日常營運與決策。",
